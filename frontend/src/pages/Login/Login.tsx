    ...
    <div className={styles.loginPage}>
      ...
      <div className={styles.loginContainer}>
        <div className={styles.logoSection}>
          ...
          />
          <h1 className={styles.title}>Добро пожаловать в <span>Eventify</span></h1>
        ...
        <div className={styles.formSection}>
          ...
          <div className={styles.registerLink}>
            Нет аккаунта? <Link to="/register">Зарегистрируйтесь</Link><br></br>
            
            <Link to="/" className={styles.homeButton}>На главную
            </Link>
          </div>
